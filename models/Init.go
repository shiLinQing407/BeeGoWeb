...
func Init() {
	...
	orm.RegisterModelWithPrefix("go_", new(news.News), new(news.NewsClass), new(system.User), new(log.Log), new(system.Menu), new(system.Role), new(system.RoleMenuRel),new(system.RoleUserRel))
